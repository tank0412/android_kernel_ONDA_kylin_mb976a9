...
int inv_sensors_power_on(struct invsens_platform_data_t *pdata)
{
	...
	pr_debug(KERN_INFO "inv_sensors_power_on call");
...
int inv_sensors_power_off(struct invsens_platform_data_t *pdata)
{
	...
	pr_debug(KERN_INFO "inv_sensors_power_off call");
...
int inv_sensors_parse_secondary(struct device *dev, struct invsens_platform_data_t *pdata)
{
	int rc;
	struct device_node *np = dev->of_node;
	u32 temp_val;
...
int inv_sensors_parse_aux(struct device *dev, struct invsens_platform_data_t *pdata)
{
#if 0
	int rc;
	struct device_node *np = dev->of_node;
...
int inv_sensors_parse_dt(struct device *dev, struct invsens_platform_data_t *pdata)
{
	int rc;
